...
# Canonical 66-book Protestant order
BOOKS = [
...
# USFM 3-letter codes → canonical name
USFM_TO_BOOK = {
...
def verses_for_book(translation: dict, book: str) -> list[str]:
    """Return all verse strings for a given book, in order."""
    items = sorted(
        ((ch, vs, text) for (b, ch, vs), text in translation.items() if b == book),
        key=lambda x: (x[0], x[1]),
    )
    return [text for _, _, text in items]


def all_sentences(translation: dict) -> list[list[str]]:
    """Return all verses as tokenized word lists (for Word2Vec training)."""
    return [_tokenize(text) for text in translation.values()]
...
def _verse_counts_per_chapter() -> dict[str, dict[int, int]]:
    """
    Hardcoded Protestant canon verse counts per chapter.
    Source: standard KJV verse count table.
    """
    return {
        ...
        "Leviticus": {1:17,2:16,3:17,4:35,5:19,6:30,7:38,8:36,9:24,10:20,
        ...
        "Joshua": {1:18,2:24,3:17,4:24,5:15,6:27,7:26,8:35,9:27,10:43,
                   11:23,12:24,13:33,14:15,15:63,16:10,17:18,18:28,19:51,20:9,
                   21:45,22:34,23:16,24:33},
        "Judges": {1:36,2:23,3:31,4:24,5:31,6:40,7:25,8:35,9:57,10:18,
                   11:40,12:15,13:25,14:20,15:20,16:31,17:13,18:31,19:30,20:48,21:25},
        "Ruth": {1:22,2:23,3:18,4:22},
        "1 Samuel": {1:28,2:36,3:21,4:22,5:12,6:21,7:17,8:22,9:27,10:27,
        ...
        "2 Samuel": {1:27,2:32,3:39,4:12,5:25,6:23,7:29,8:18,9:13,10:19,
                     11:27,12:31,13:39,14:33,15:37,16:23,17:29,18:33,19:43,20:26,
                     21:22,22:51,23:39,24:25},
        "1 Kings": {1:53,2:46,3:28,4:34,5:18,6:38,7:51,8:66,9:28,10:29,
                    11:43,12:33,13:34,14:31,15:34,16:34,17:24,18:46,19:21,20:43,21:29,22:53},
        "2 Kings": {1:18,2:25,3:27,4:44,5:27,6:33,7:20,8:29,9:37,10:36,
                    11:21,12:21,13:25,14:29,15:38,16:20,17:41,18:37,19:37,20:21,
                    21:26,22:20,23:37,24:20,25:30},
        "1 Chronicles": {1:54,2:55,3:24,4:43,5:26,6:81,7:40,8:40,9:44,10:14,
                         11:47,12:40,13:14,14:17,15:29,16:43,17:27,18:17,19:19,20:8,
                         21:30,22:19,23:32,24:31,25:31,26:32,27:34,28:21,29:30},
        "2 Chronicles": {1:17,2:18,3:17,4:22,5:14,6:42,7:22,8:18,9:31,10:19,
        ...
        "Nehemiah": {1:11,2:20,3:32,4:23,5:19,6:19,7:73,8:18,9:38,10:39,
                     11:36,12:47,13:31},
        ...
        "Psalms": {1:6,2:12,3:8,4:8,5:12,6:10,7:17,8:9,9:20,10:18,
        ...
        "Proverbs": {1:33,2:22,3:35,4:27,5:23,6:35,7:27,8:36,9:18,10:32,
        ...
        "Isaiah": {1:31,2:22,3:26,4:6,5:30,6:13,7:25,8:23,9:21,10:34,
        ...
        "Jeremiah": {1:19,2:37,3:25,4:31,5:31,6:30,7:34,8:22,9:26,10:25,
        ...
        "Ezekiel": {1:28,2:10,3:27,4:17,5:17,6:14,7:27,8:18,9:11,10:22,
        ...
        "Acts": {1:26,2:47,3:26,4:37,5:42,6:15,7:60,8:40,9:43,10:48,
        ...
        "2 Corinthians": {1:24,2:17,3:18,4:18,5:21,6:18,7:16,8:24,9:15,10:18,
                          11:33,12:21,13:14},
        ...
        "Philemon": {1:25},
        "Hebrews": {1:14,2:18,3:19,4:16,5:14,6:20,7:28,8:13,9:28,10:39,
                    11:40,12:29,13:25},
        ...
        "3 John": {1:14},
        "Jude": {1:25},
        "Revelation": {1:20,2:29,3:22,4:11,5:14,6:17,7:17,8:13,9:21,10:11,
                       11:19,12:17,13:18,14:20,15:8,16:21,17:18,18:24,19:21,20:15,21:27,22:21},
    }
